...
# -*- coding: utf-8 -*-
#
# yuntongxun-restapi-asyncio documentation build configuration file, created by
# sphinx-quickstart on Tue Apr 12 11:05:27 2016.
#
...
project = 'yuntongxun-restapi-asyncio'
...
html_theme_options = {
    ...
    'github_banner': True,
    'github_user': 'tanbro',
    'github_repo': 'yuntongxun-restapi-asyncio',
}
...
# html_title = 'yuntongxun-restapi-asyncio v0.1'
...
htmlhelp_basename = 'yuntongxun-restapi-asynciodoc'
...
latex_documents = [
    (master_doc, 'yuntongxun-restapi-asyncio.tex', 'yuntongxun-restapi-asyncio Documentation',
     'liu xue yan', 'manual'),
]
...
man_pages = [
    (master_doc, 'yuntongxun-restapi-asyncio', 'yuntongxun-restapi-asyncio Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'yuntongxun-restapi-asyncio', 'yuntongxun-restapi-asyncio Documentation',
     author, 'yuntongxun-restapi-asyncio', 'One line description of project.',
     'Miscellaneous'),
]
